...
public class HolonomicDriveController2635 extends HolonomicDriveController{
  ...
  public ChassisSpeeds calculate(
    ...
    double xFF = desiredLinearVelocityMetersPerSecond * trajectoryPose.getRotation().getCos() * 0.85; // Fudge factor of 3/4 to adjust the speed
    double yFF = desiredLinearVelocityMetersPerSecond * trajectoryPose.getRotation().getSin() * 0.85;
    double thetaFF =
